...
# This file contains the logic used to classify lists as instruction sets, and filter out irrelevant
# lists, we do this by creating a coefficient value for each element of a list, adding the relevant 
# number in the FREQUENT_WORD_COEFFICIENTS set when we find its paired word in the list
# If you want to learn where the value was drawn from, check the 'instructions-training' folder
...
FREQUENT_WORD_COEFFICIENTS = [('bring', 2.1666666666666665), ('two', 2.2), ('bake', 2.2857142857142856), ('rise', 2.5), ('garnish', 2.5), ('cake', 2.5555555555555554), ('milk', 2.75), ('f', 2.75), ('set', 2.888888888888889), ('egg', 3.0), ('step', 3.0), ('plastic', 3.0), 
                              ...
                              ('frequently', 6.0), ('tray', 6.0), ('drain', 6.0), ('aluminum', 6.0), ('stretch', 6.0), ('thin', 6.0), ('nonstick', 6.0), ('prepared', 6.0), ('begin', 6.0), ('beginning', 6.0), ('center', 6.0), ('cook', 6.444444444444445), ('ready', 6.5), 
                              ...
                              ('remaining', 11.0), ('browned', 11.0), ('ï', 11.0), ('refrigerate', 11.0), ('rack', 11.0), ('completely', 11.0), ('stand', 11.0), ('mixer', 11.0), ('seconds', 11.0), ('aside', 11.5), ('stirring', 12.0), ('sausage', 12.0), ('beat', 12.0), ('bowl', 12.4), 
                              ...
                              ('spatula', 16.0), ('season', 17.0), ('together', 18.0), ('preheat', 22.0), ('lightly', 22.0), ('transfer', 25.0), ('½', 13.0), ('whisk', 30.0), ('cover', 33.0), ('place', 45.0), ('combine', 59.0)]

def get_lower_bound(): 
    # Each individual instruction is likely to be reasonably long, this will exclude unusually short sets
...
def get_instruction_coefficient(list_set):
    # We can find the occurence of each frequent word and compare to set the coefficient
    ...
    # we will need to normalize the coefficient for different sized lists
...
# We also want to classify lists as ingredient sets, we do that here
# We want to detect how often the regex in 'regex.py' finds an amount and a unit value
